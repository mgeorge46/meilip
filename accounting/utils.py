...
# Payroll (Phase 5) — NSSF removed in Phase 6 per simplified-payroll requirement.
SYS_STAFF_ADVANCES_RECEIVABLE = "STAFF_ADVANCES_RECEIVABLE"
SYS_SALARIES_PAYABLE = "SALARIES_PAYABLE"
SYS_PAYE_PAYABLE = "PAYE_PAYABLE"
SYS_OTHER_PAYROLL_PAYABLE = "OTHER_PAYROLL_PAYABLE"
SYS_SALARIES_EXPENSE = "SALARIES_EXPENSE"
SYS_ALLOWANCES_EXPENSE = "ALLOWANCES_EXPENSE"

# Utility income (Phase 6) — separately-billed utilities when flagged at
# estate/house level. Each line writes to its own Income account so that
# landlord statements and reports break them out from Rent Income.
SYS_WATER_INCOME = "WATER_INCOME"
SYS_GARBAGE_INCOME = "GARBAGE_INCOME"
SYS_SECURITY_INCOME = "SECURITY_INCOME"
SYS_ELECTRICITY_INCOME = "ELECTRICITY_INCOME"
SYS_OTHER_UTILITY_INCOME = "OTHER_UTILITY_INCOME"
